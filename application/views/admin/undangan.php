                ...
                <div class="row mt">
                  <div class="col-lg-12"> 
                    <div class="form-panel">
                        ...
                        <?php endif; ?>
                        <center><h4 class="mb"><i class="fa"></i>Undangan Rapat</h4></center>
                       ...
                       <?php echo form_open(); ?> 
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="undangan" value="<?php echo $editdata->undangan; ?> ?>" class="form-control"></textarea>
                                </div>
                        </div><br><br>
                        <div class="form-group">
                            <center><input type="submit" class="btn btn-primary" name="submit" value="Kirim Undangan"></input></center>
                        </div>  
                      <?php echo form_close(); ?>
                    </div>
                  </div> 
